...
// The file has import for lucide-react. Let's add Database, CheckCircle2, Compass, BookOpen if not there
...
const newTopPart = `
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-b-2xl rounded-tr-2xl border border-slate-100 p-5 sm:p-8 shadow-sm min-h-[400px] -mt-6">
        ...
        {activeDivision === 'academia' && <ResearchLecturesNavCMS filterTab="academia" />}
        {activeDivision === 'navigation' && <ResearchLecturesNavCMS filterTab="navigation" />}
