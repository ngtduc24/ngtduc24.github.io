...
function jVList(){
  ...
  h+='<div class="jtbl"><table><thead><tr><th style="width:28px">☑</th><th style="width:36px">TT</th><th style="min-width:180px">Tên tạp chí<div class="col-resize" onmousedown="jColResize(event)"></div></th><th style="min-width:80px">ISSN<div class="col-resize" onmousedown="jColResize(event)"></div></th><th style="min-width:55px">Loại<div class="col-resize" onmousedown="jColResize(event)"></div></th><th style="min-width:100px">Cơ quan XB<div class="col-resize" onmousedown="jColResize(event)"></div></th><th style="min-width:100px">Ngành<div class="col-resize" onmousedown="jColResize(event)"></div></th><th style="min-width:60px">Điểm</th><th style="min-width:90px">Ngày nhập</th><th style="width:36px">Sửa</th><th style="width:36px"></th></tr></thead><tbody id="jTB"></tbody></table></div>';
...
function jColResize(e){
  ...
  function onMove(ev){th.style.width=(startW+(ev.clientX-startX))+'px';th.style.minWidth=th.style.width;}
