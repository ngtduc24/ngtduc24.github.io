        ...
        <div className="px-6 py-4.5 bg-slate-900 text-white flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold shadow-md shadow-emerald-900/30 transition-all cursor-pointer"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="relative md:col-span-2">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
            ...
            {isAdmin ? (
              ...
              <div className="px-3 py-2 bg-emerald-50 border border-emerald-100 rounded-xl text-xs text-emerald-800 font-semibold flex items-center gap-1.5">
            ...
            {isAdmin && (
              <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-2xs flex items-center justify-between col-span-2 sm:col-span-1">
                <div>
                  ...
                  <span className="text-xl font-extrabold text-emerald-600">{stats.totalIncome.toLocaleString()} đ</span>
                </div>
                      ...
                      <React.Fragment key={t.id}>
                        ...
                        {isExpanded && t.completionReport && (
                          <tr className="bg-emerald-50/30">
                            <td colSpan={isAdmin ? 7 : 6} className="p-4 border-t border-b border-emerald-100">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                      {t.completionReport.deliverables.map((link, lIdx) => (
                                        <a
                                          ...
                                          target="_blank"
                                          rel="noreferrer"
                                          className="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 rounded-lg text-xs text-emerald-700 transition-colors"
                                        >
