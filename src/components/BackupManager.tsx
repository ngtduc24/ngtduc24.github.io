...
export default function BackupManager() {
  ...
  const supabaseTables = [
    ...
    { id: 'media_library', label: 'Thư viện Cloudinary dùng chung' },
    ...
    { id: 'portfolio_course_chapters', label: 'Portfolio — Chương học' },
    { id: 'portfolio_course_lessons', label: 'Portfolio — Bài học' },
    { id: 'portfolio_course_students', label: 'Portfolio — Học viên' },
    { id: 'portfolio_research', label: 'Portfolio — Nghiên cứu' },
    { id: 'portfolio_lectures', label: 'Portfolio — Bài giảng' }
  ];
