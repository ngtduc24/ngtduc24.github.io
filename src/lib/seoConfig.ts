...
export const SEO_MODULES: Record<string, SeoModuleMeta> = {
  ...
  utility_file_compress: {
    ...
    title: 'Giảm dung lượng file | SmartResearch',
  ...
  edu_bank: {
    ...
    title: 'Ngân hàng bài tập | SmartResearch',
  ...
  edu_exam: {
    id: 'edu_exam',
    slug: 'trac-nghiem',
    title: 'Kiểm tra trắc nghiệm | SmartResearch',
  ...
  edu_question_bank: {
    ...
    title: 'Ngân hàng câu hỏi | SmartResearch',
