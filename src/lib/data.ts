...
export async function saveUser(user: UserAccount) {
  ...
  try {
    const dbData = {
      ...
      can_manage_edu: user.canManageEdu,
      can_create_edu: user.canCreateEdu,
      can_edit_edu: user.canEditEdu,
      can_delete_edu: user.canDeleteEdu,
      can_import_edu: user.canImportEdu,
      can_export_edu: user.canExportEdu,
      can_grade_edu: user.canGradeEdu,
      can_grade_import_edu: user.canGradeImportEdu,
      can_portfolio_content: user.canPortfolioContent,
      can_portfolio_projects: user.canPortfolioProjects,
      can_portfolio_courses: user.canPortfolioCourses,
      ...
      can_remier_shared: user.canRemierShared,
      avatar_url: user.avatarUrl,
      cover_image: user.coverImage,
      cover_image_position: user.coverImagePosition,
...
export function mapUserFromDB(u: any): UserAccount {
  return {
    ...
    canManageEdu: u.can_manage_edu,
    canCreateEdu: u.can_create_edu,
    canEditEdu: u.can_edit_edu,
    canDeleteEdu: u.can_delete_edu,
    canImportEdu: u.can_import_edu,
    canExportEdu: u.can_export_edu,
    canGradeEdu: u.can_grade_edu,
    canGradeImportEdu: u.can_grade_import_edu,
    canPortfolioContent: u.can_portfolio_content,
    canPortfolioProjects: u.can_portfolio_projects,
    canPortfolioCourses: u.can_portfolio_courses,
    ...
    canRemierShared: u.can_remier_shared,
    avatarUrl: u.avatar_url,
    coverImage: u.cover_image,
    coverImagePosition: u.cover_image_position,
